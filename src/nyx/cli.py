...
def cmd_test(args: argparse.Namespace) -> int:
    ...
    elements = [
        DOMElement(index=0, tag="h1", text="Example Domain",
                   depth=2, sibling_index=0, child_count=0,
                   x=100, y=100, width=400, height=40),
        DOMElement(index=1, tag="p", text="This domain is for use in illustrative examples",
                   depth=2, sibling_index=1, child_count=0,
                   x=100, y=160, width=400, height=60),
        DOMElement(index=2, tag="a", text="More information...",
                   depth=3, sibling_index=0, child_count=0,
                   x=100, y=240, width=150, height=20,
                   attrs={"href": "https://www.iana.org/domains/example"}),
        DOMElement(index=3, tag="input", text="",
        ...
        DOMElement(index=4, tag="button", text="Submit",
    ...
    if heading:
        print(f"    → <{heading.element.tag}> \"{heading.element.text[:60]}\" ({heading.confidence}%)")
    ...
    redesigned = [
        DOMElement(index=0, tag="h1", text="Example Domain",
                   depth=3, sibling_index=0, child_count=0,
                   x=50, y=80, width=500, height=50),
        DOMElement(index=1, tag="p", text="This domain is for use in illustrative examples",
                   depth=3, sibling_index=1, child_count=0,
                   x=50, y=140, width=500, height=70),
        DOMElement(index=2, tag="a", text="More information...",
                   depth=5, sibling_index=0, child_count=0,
                   x=50, y=230, width=180, height=25,
                   attrs={"href": "https://www.iana.org/domains/example"}),
        DOMElement(index=3, tag="input", text="",
                   depth=6, sibling_index=0, child_count=0,
                   x=150, y=320, width=250, height=35,
                   attrs={"type": "email", "placeholder": "Enter your email",
                          "name": "email", "aria-label": "Email address"}),
        DOMElement(index=4, tag="button", text="Submit",
                   depth=6, sibling_index=1, child_count=0,
                   x=150, y=365, width=120, height=35,
                   attrs={"type": "submit"}),
    ]
    ...
    print(f"    → Before: {int(before_score * 100)}%, After: {int(after_score * 100)}%, Same: {same}")
...
def main() -> int:
    ...
    p_find.add_argument("--dom", required=True, help="Path to JSON file with extracted DOM elements")
    ...
    p_analyze.add_argument("--dom", required=True, help="Path to JSON file with extracted DOM elements")
